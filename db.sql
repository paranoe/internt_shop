-- =============================================
-- 1. Удаление всех таблиц (чистое создание)
-- =============================================
...
DROP TABLE IF EXISTS podcategories CASCADE;
DROP TABLE IF EXISTS user_pickup_points CASCADE;
...
-- Справочники ролей / пользователей
